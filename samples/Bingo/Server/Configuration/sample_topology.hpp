...
struct sample_topology_t
{
    static sample_topology_t bind (const configuration_section_t &section)
    {
        ...
        topology.api_channel_endpoint = section.get ("apiChannelEndpoint")
                                          .value_or (topology.api_channel_endpoint);
        topology.api_a_channel_endpoint = section.get ("apiAChannelEndpoint")
                                            .value_or (topology.api_a_channel_endpoint);
        topology.api_b_channel_endpoint = section.get ("apiBChannelEndpoint")
                                            .value_or (topology.api_b_channel_endpoint);
        topology.play_channel_endpoint = section.get ("playChannelEndpoint")
                                           .value_or (topology.play_channel_endpoint);
        topology.play_a_channel_endpoint = section.get ("playAChannelEndpoint")
                                             .value_or (topology.play_a_channel_endpoint);
        topology.play_b_channel_endpoint = section.get ("playBChannelEndpoint")
                                             .value_or (topology.play_b_channel_endpoint);
        ...
        topology.api_a_play_route_endpoint = section.get ("apiAPlayRouteEndpoint")
                                               .value_or (topology.api_a_play_route_endpoint);
        topology.api_b_play_route_endpoint = section.get ("apiBPlayRouteEndpoint")
                                               .value_or (topology.api_b_play_route_endpoint);
        topology.api_a_matchmaking_route_endpoint = section.get ("apiAMatchmakingRouteEndpoint")
                                                      .value_or (
                                                        topology.api_a_matchmaking_route_endpoint);
        topology.api_b_matchmaking_route_endpoint = section.get ("apiBMatchmakingRouteEndpoint")
                                                      .value_or (
                                                        topology.api_b_matchmaking_route_endpoint);
        topology.session_a_route_endpoint = section.get ("sessionAPlayRouteEndpoint")
                                              .value_or (topology.session_a_route_endpoint);
        topology.session_b_route_endpoint = section.get ("sessionBPlayRouteEndpoint")
                                              .value_or (topology.session_b_route_endpoint);
        topology.matchmaking_route_endpoint = section.get ("matchmakingRouteEndpoint")
        ...
        topology.session_spot_endpoint = section.get ("sessionSpotEndpoint")
                                           .value_or (topology.session_spot_endpoint);
        topology.session_router_endpoint = section.get ("sessionRouterEndpoint")
                                             .value_or (topology.session_router_endpoint);
        ...
        topology.session_a_stream_endpoint = section.get ("sessionAStreamEndpoint")
                                               .value_or (topology.session_a_stream_endpoint);
        topology.session_b_stream_endpoint = section.get ("sessionBStreamEndpoint")
                                               .value_or (topology.session_b_stream_endpoint);
